...
public class MortgageCalculator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/MortgageBkgResized.png"))); // NOI18N
    ...
    private void HPFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_HPFieldKeyReleased
        if (allFieldsHaveValue()) {
                    calcButton.setEnabled(true);
                }
    }//GEN-LAST:event_HPFieldKeyReleased

    private void DPFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DPFieldKeyReleased
        if (allFieldsHaveValue()) {
                    calcButton.setEnabled(true);
                }
    }//GEN-LAST:event_DPFieldKeyReleased

    private void LTFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_LTFieldKeyReleased
        if (allFieldsHaveValue()) {
                    calcButton.setEnabled(true);
                }
    }//GEN-LAST:event_LTFieldKeyReleased
    ...
    private void SDFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_SDFieldKeyReleased
        if (allFieldsHaveValue()) {
                    calcButton.setEnabled(true);
                }
    }//GEN-LAST:event_SDFieldKeyReleased
    ...
    private void setResultsLabelsNotVisible() {
        ...
        numMPLabel.setText("Total of ____ Mortgage Payments");
    }
